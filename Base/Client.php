...
abstract class Client implements ActiveRecordInterface
{
    ...
    public function setAge($v)
    {
        ...
        if ($this->age !== $v) {
            $this->age = $v;
            $this->modifiedColumns[ClientTableMap::COL_AGE] = true;
        }
    ...
    public function setCp($v)
    {
        ...
        if ($this->cp !== $v) {
            $this->cp = $v;
            $this->modifiedColumns[ClientTableMap::COL_CP] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ClientTableMap::translateFieldName('Age', TableMap::TYPE_PHPNAME, $indexType)];
            $this->age = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ClientTableMap::translateFieldName('Telephone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->telephone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ClientTableMap::translateFieldName('Adresse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->adresse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ClientTableMap::translateFieldName('Cp', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = ClientTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ClientTableMap::COL_AGE)) {
        ...
        if ($this->isColumnModified(ClientTableMap::COL_CP)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClientTableMap::COL_AGE)) {
            $criteria->add(ClientTableMap::COL_AGE, $this->age);
        }
        if ($this->isColumnModified(ClientTableMap::COL_TELEPHONE)) {
        ...
        if ($this->isColumnModified(ClientTableMap::COL_CP)) {
            $criteria->add(ClientTableMap::COL_CP, $this->cp);
        }
